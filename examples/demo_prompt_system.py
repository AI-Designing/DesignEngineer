...
def demo_advanced_prompt_engineering():
    ...
    print("   🎯 Main Objective: Create parametric gear assembly with precise involute teeth")
    print("   📊 Complexity Level: Advanced")
    print("   ✅ Key Requirements: 5 identified (teeth count, profiles, parametric, etc.)")
    print("   ⚠️  Potential Challenges: 4 identified (involute mathematics, assembly constraints)")
