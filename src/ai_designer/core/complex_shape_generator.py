...
class ComplexShapeGenerator:
    ...
    def __init__(self, llm_client: LLMClient, state_analyzer: FreeCADStateAnalyzer, 
                 command_executor: CommandExecutor, state_cache: Optional[StateCache] = None):
        """
    ...
    def generate_complex_shape(self, user_requirements: str, session_id: str, 
                             target_complexity: ComplexityLevel = ComplexityLevel.INTERMEDIATE) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            documentation = self._generate_documentation(
                user_requirements, decomposition_plan, execution_result, validation_result
            )
            ...
            return {
                ...
                'generation_history': [step.__dict__ for step in self.generation_history]
            }
    ...
    def _analyze_current_state(self, session_id: str) -> StateAnalysisResult:
        ...
        if self.state_cache:
            self.state_cache.set_state(f"complex_state_{session_id}", state_result.__dict__)
        
        return state_result
    
    def _generate_decomposition_plan(self, user_requirements: str, 
                                   current_state: StateAnalysisResult,
                                   target_complexity: ComplexityLevel) -> List[ShapeGenerationStep]:
        """
    ...
    def _execute_generation_plan(self, plan: List[ShapeGenerationStep], 
                               session_id: str, user_requirements: str) -> Dict[str, Any]:
        """
        ...
        for i, step in enumerate(plan):
            ...
            feedback = self._get_llm_feedback(step, pre_state, post_state, user_requirements)
            ...
            if not step_result.get('status') == 'success':
                ...
                recovery_result = self._attempt_step_recovery(step, step_result, post_state)
    ...
    def _execute_single_step(self, step: ShapeGenerationStep, session_id: str) -> Dict[str, Any]:
        """
    ...
    def _get_llm_feedback(self, step: ShapeGenerationStep, pre_state: StateAnalysisResult,
                         post_state: StateAnalysisResult, user_requirements: str) -> Dict[str, Any]:
        """
        Get LLM feedback on step execution and state changes
        """
        feedback_prompt = self._create_feedback_prompt(step, pre_state, post_state, user_requirements)
...
"""
    ...
    def _create_feedback_prompt(self, step: ShapeGenerationStep, pre_state: StateAnalysisResult,
                               post_state: StateAnalysisResult, user_requirements: str) -> str:
        """
...
"""
    ...
    def _get_available_operations(self) -> List[str]:
        ...
        return [
            ...
            "create_torus", "create_prism", "extrude", "revolve", "loft",
            "boolean_union", "boolean_difference", "boolean_intersection",
            "fillet", "chamfer", "mirror", "linear_pattern", "circular_pattern",
            "sketch", "constraint", "dimension", "assembly"
        ]
    ...
    def _identify_design_constraints(self, objects: List[Dict], relationships: Dict) -> List[str]:
        """Identify design constraints from current state"""
        return ["constraint_1", "constraint_2"]
    
    def _generate_next_actions(self, objects: List[Dict], relationships: Dict) -> List[str]:
    ...
    def _calculate_quality_metrics(self, objects: List[Dict], relationships: Dict) -> Dict[str, float]:
    ...
    def _optimize_generation_plan(self, steps: List[ShapeGenerationStep], 
                                context: Dict[str, Any]) -> List[ShapeGenerationStep]:
    ...
    def _validate_step_completion(self, step: ShapeGenerationStep, results: List[Dict]) -> Dict[str, Any]:
    ...
    def _adapt_plan_based_on_feedback(self, remaining_steps: List[ShapeGenerationStep],
                                    feedback: Dict[str, Any], current_state: StateAnalysisResult,
                                    user_requirements: str) -> List[ShapeGenerationStep]:
        """Adapt the remaining plan based on LLM feedback"""
        # Simplified adaptation - could involve re-planning with LLM
        return remaining_steps
    
    def _attempt_step_recovery(self, step: ShapeGenerationStep, step_result: Dict[str, Any],
                             current_state: StateAnalysisResult) -> Dict[str, Any]:
    ...
    def _parse_feedback_response(self, response: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"step_success": False, "progress_assessment": "Failed to parse feedback"}
    
    def _validate_generation_result(self, user_requirements: str, initial_state: StateAnalysisResult,
                                  final_state: StateAnalysisResult) -> Dict[str, Any]:
    ...
    def _generate_documentation(self, user_requirements: str, plan: List[ShapeGenerationStep],
                              execution_result: Dict[str, Any], validation_result: Dict[str, Any]) -> Dict[str, Any]:
