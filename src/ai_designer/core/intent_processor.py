...
class IntentProcessor:
    ...
    def __init__(self, state_service=None, llm_client=None):
        ...
        self.intent_patterns = {
            ...
            "delete_object": [r"delete.*", r"remove.*", r"clear.*"],
            "query_info": [
                r"what.*",
                r"how.*",
                r"show.*objects",
    ...
    def process_intent(self, user_input: str, session_id: str = None) -> Dict[str, Any]:
        ...
        action_plan = self._create_action_plan(
            user_input, intent_classification, context_analysis
        )
    ...
    def _classify_intent(self, user_input: str) -> Dict[str, Any]:
        ...
        if intent_scores:
            best_intent = max(
                intent_scores.keys(), key=lambda x: intent_scores[x]["score"]
            )
    ...
    def _create_action_plan(
        self, user_input: str, intent: Dict[str, Any], context: Dict[str, Any]
    ) -> Dict[str, Any]:
