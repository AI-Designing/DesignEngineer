...
"""
    ...
    def _parse_face_analysis_result(self, result: str, object_name: str) -> List[FaceInfo]:
...
class FaceSelector:
    ...
    def select_optimal_face(self, 
                          objects: List[str], 
                          operation_type: str,
                          user_criteria: str = "") -> Optional[FaceInfo]:
        """
        ...
        print(f"   ✅ Selected: {best_face.object_name}.{best_face.face_id} (score: {best_face.suitability_score:.2f})")
        
        return best_face
    
    def _apply_user_criteria(self, faces: List[FaceInfo], criteria: str) -> List[FaceInfo]:
    ...
    def _filter_for_operation(self, faces: List[FaceInfo], operation_type: str) -> List[FaceInfo]:
