...
class StateCache:
    ...
    def generate_state_key(self, document_name: str = None, session_id: str = None) -> str:
    ...
    def generate_analysis_key(self, document_name: str = None, analysis_type: str = "general") -> str:
    ...
    def cache_state(self, state_data: Dict[str, Any], state_key: str = None, 
                   document_name: str = None, session_id: str = None, 
    ...
    def cache_analysis(self, analysis_data: Dict[str, Any], analysis_key: str = None,
                      document_name: str = None, analysis_type: str = "general",
                      expiration: int = None) -> str:
        """
    ...
    def list_states(self, document_name: str = None, session_id: str = None) -> List[str]:
    ...
    def list_analyses(self, document_name: str = None, analysis_type: str = None) -> List[str]:
    ...
    def get_latest_state(self, document_name: str = None, session_id: str = None) -> Optional[str]:
        """Get the most recent state key for a document/session"""
        keys = self.list_states(document_name, session_id)
        return keys[-1] if keys else None
    
    def get_latest_analysis(self, document_name: str = None, analysis_type: str = None) -> Optional[str]:
    ...
    def get_metadata_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "documents": list(set(self._extract_document_names(state_keys + analysis_keys)))
        }
    ...
    def _update_metadata_index(self, key: str, metadata: Dict[str, Any]):
        ...
        self.redis_client.set(metadata_key, json.dumps(metadata), ex=86400)  # 24 hour expiry
