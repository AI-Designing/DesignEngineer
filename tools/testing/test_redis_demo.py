...
def demo_redis_state_management():
    ...
    freecad_state = {
        ...
        "active_objects": [
            {"name": "Body", "type": "PartDesign::Body", "features": ["Sketch", "Pad"]},
            {
                "name": "Sketch",
        ...
        "constraints": {"horizontal": 2, "vertical": 1, "dimensional": 3},
    ...
    llm_analysis = {
        ...
        "recommended_next_steps": [
            ...
            },
            {
                ...
                "parameters": {"radius": "2mm", "edges": "all_exterior_edges"},
                "confidence": 0.80,
            },
        ],
        "risk_assessment": {
    ...
    print(
        f"   📋 Recommended steps: {len(retrieved_analysis['recommended_next_steps'])}"
    )
