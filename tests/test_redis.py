...
class TestStateCache(unittest.TestCase):
    ...
    def test_cache_and_retrieve_state(self):
        ...
        state_key = self.state_cache.cache_state(
            state_data, document_name="test_document", session_id="test_session"
        )
    ...
    def test_cache_and_retrieve_analysis(self):
        ...
        analysis_key = self.state_cache.cache_analysis(
            analysis_data, document_name="test_document", analysis_type="state_analysis"
        )
    ...
    def test_list_states(self):
        ...
        key1 = self.state_cache.cache_state(
            state1, document_name="test_document", session_id="session1"
        )
        key2 = self.state_cache.cache_state(
            state2, document_name="test_document", session_id="session2"
        )
