...
def test_deepseek_integration():
    ...
    try:
        ...
        from ai_designer.llm.deepseek_client import (
            DeepSeekR1Client, DeepSeekConfig, DeepSeekMode, DeepSeekIntegrationManager
        )
        ...
        try:
            ...
            deepseek_status = generator.test_deepseek_connection() if client else {"status": "not_available"}
        ...
        if client:
            try:
                ...
                # Test mode selection
                mode = manager._select_optimal_mode("Create a complex gear assembly", None)
        ...
        if client:
            try:
                ...
                print(f"   🧠 Reasoning insights: {len(insights.get('insights', []))} insights")
